...
*/
    ...
    pa();
    F("Edge");
    !F("Gecko") || -1 != D().toLowerCase().indexOf("webkit") && !F("Edge") || F("Trident") || F("MSIE") || F("Edge"); - 1 != D().toLowerCase().indexOf("webkit") && !F("Edge") && F("Mobile");
    H() || F("Macintosh");
    H() || F("Windows");
    ...
    var N, za = !1,
        ...
        Ba = function() {
            if (l.Promise && l.Promise.resolve) {
                ...
                var b = Ca;
                "function" !== typeof l.setImmediate || l.Window && l.Window.prototype && (G() || !F("Edge")) && l.Window.prototype.setImmediate == l.setImmediate ? (K || (K = ta()), K(b)) : l.setImmediate(b)
            }
        },
        Ca = function() {
    ...
    var Ja = function(a, b) {
            if (0 == a.g)
                if (a.m) {
                    var c = a.m;
                    if (c.i) {
                        for (var d = 0, e = null, g = null, k = c.i; k && (k.v || (d++, k.child == a && (e = k), !(e && 1 < d))); k = k.next) e || (g = k);
                        e && (0 == c.g && 1 == d ? Ja(c, b) : (g ? (d = g, w(c.i), w(null != d), d.next == c.s && (c.s = d), d.next = d.next.next) : Ka(c), La(c, e, 3, b)))
                    }
                    a.m = null
                } else P(a, 3, b)
        },
    ...
    var P = function(a, b, c) {
            0 == a.g && (a === c && (b = 3, c = new TypeError("Promise cannot resolve to itself")), a.g = 1, Ga(c, a.ga, a.ha, a) || (a.V = c, a.g = b, a.m = null, Ma(a), 3 != b || c instanceof Q || Oa(a, c)))
        },
        Ga = function(a, b, c, d) {
            if (a instanceof R) return null != b && x(b, "opt_onFulfilled should be a function."), null != c && x(c, "opt_onRejected should be a function. Did you pass opt_context as the second argument instead of the third?"), Na(a, Fa(b || I, c || null, d)), !0;
            if (a) try {
        ...
        return new R(function(b, c) {
            ...
            if (d)
                for (var g = function(n, q) {
                        ...
                        c(n)
                    }, f = 0, h; f < a.length; f++) h = a[f], Ha(h, ka(g, f), k);
            else b(e)
        })
    };
    ...
    V.prototype.ia = function(a) {
        void 0 !== this.h && void 0 !== this.h[a] && (delete this.h[a], --this.U, 0 === this.U && void 0 !== this.K && this.K(this))
    };
    var Wa = function(a, b) {
            if (!a.A)
                for (var c = 0; c < a.h.length; c++) Za(a, c, b)
        },
        Za = function(a, b, c) {
            a.task.then(function() {
                if (void 0 !== a.h && void 0 !== a.h[b]) try {
                    c(a.h[b])
                } catch (d) {
    ...
    V.prototype.close = function(a) {
        var b = this;
        this.A || (this.A = !0, void 0 !== a && (this.R = a), this.task.then(function() {
            b.h = void 0;
            b.K = void 0
        }))
    };
    ...
    X.prototype.ba = function(a, b) {
        ...
        var c = b || "[DEFAULT]";
        return "undefined" === typeof this.j[a][c] ? (b = this.S.INTERNAL.factories[a](this, this.aa.bind(this), b), this.j[a][c] = b) : this.j[a][c]
    };
    ...
    function $a() {
        ...
        function c(f, h) {
            ...
            var n = h;
            f = f.options;
            "auth" === h && (f.serviceAccount || f.credential) && (n = "serverAuth", "serverAuth" in e || Z("sa-not-supported"));
            return n
        }
        var d = {},
            e = {},
...
(function() {
    ...
    */
    ...
    ea("Promise", function(a) {
        ...
        e.prototype.Mj = function(g, h) {
            if (0 != this.Ba) throw Error("Cannot settle(" + g + ", " + h + "): Promise already settled in state" + this.Ba);
            this.Ba = g;
            this.Ua = h;
            2 === this.Ba && this.hm();
            this.Ik()
        ...
        e.prototype.Ik = function() {
            if (null != this.Ad) {
                for (var g =
                        0; g < this.Ad.length; ++g) f.Wh(this.Ad[g]);
                this.Ad = null
            }
        };
        var f = new b;
        ...
        e.prototype.then = function(g, h) {
            function l(z, R) {
                return "function" == typeof z ? function(Ca) {
                    try {
                        m(z(Ca))
                    } catch (Dc) {
                        q(Dc)
        ...
        e.all = function(g) {
            ...
            return l.done ? c([]) : new e(function(m, q) {
                ...
                var z = [],
                    R = 0;
                do z.push(void 0), R++, c(l.value).Se(x(z.length - 1), q), l = h.next(); while (!l.done)
            })
        };
        return e
    });
    ...
    ea("Map", function(a) {
        ...
        c.prototype.set = function(h, l) {
            ...
            m.Oa ? m.Oa.value = l : (m.Oa = {
                ...
                key: h,
                value: l
            }, m.list.push(m.Oa), this.Za.Zb.next = m.Oa, this.Za.Zb = m.Oa, this.size++);
            return this
        };
        c.prototype.delete = function(h) {
            h = d(this, h);
            return h.Oa && h.list ? (h.list.splice(h.index, 1), h.list.length || delete this.Xd[h.id], h.Oa.Zb.next = h.Oa.next, h.Oa.next.Zb =
                h.Oa.Zb, h.Oa.head = null, this.size--, !0) : !1
        };
    ...
    var ra = ra || {},
        ...
        u = function(a, b, c) {
            u = Function.prototype.bind && -1 != Function.prototype.bind.toString().indexOf("native code") ? ua : va;
    ...
    var w = function(a, b, c) {
        ...
        Ga = function(a, b, c) {
            "number" !== typeof a && Da("Expected number but got %s: %s.", [sa(a), a], b, Array.prototype.slice.call(arguments, 2));
            return a
        },
        Ha = function(a, b, c) {
            "string" !== typeof a && Da("Expected string but got %s: %s.", [sa(a), a], b, Array.prototype.slice.call(arguments, 2))
        },
        Ia = function(a, b, c) {
            "function" !== typeof a && Da("Expected function but got %s: %s.", [sa(a), a], b, Array.prototype.slice.call(arguments, 2))
        };
    var Ja = Array.prototype.indexOf ? function(a, b) {
        ...
        y = Array.prototype.forEach ? function(a, b) {
            w(null != a.length);
    ...
    var ob = function(a) {
        ...
        sb = function(a, b) {
            ...
            a = c.replace(qb, function(d, e) {
                ...
                d = b[e];
                return d instanceof
                kb ? lb(d) : encodeURIComponent(String(d))
            });
            return rb(a)
        },
        qb = /%{(\w+)}/g,
        pb = RegExp("^((https:)?//[0-9a-z.:[\\]-]+/|/[^/\\\\]|[^:/\\\\%]+/|[^:/\\\\%]*[?#]|about:blank#)", "i"),
        mb = {},
        rb = function(a) {
            var b = hb();
    ...
    var Lb, Mb = p.navigator;
    Lb = Mb ? Mb.userAgentData || null : null;

    function Nb(a) {
        return ab ? Lb ? Lb.brands.some(function(b) {
    ...
    function Qb() {
        return Ob() ? Nb("Chromium") : (B("Chrome") || B("CriOS")) && !(Ob() ? 0 : B("Edge")) || B("Silk")
    };
    var Rb = {},
        Sb = function(a, b) {
            this.lh = b === Rb ? a : "";
        ...
        jc = function(a, b, c) {
            if (a && a && b && b.value >= (a ? dc(hc(ic(), null)) : Vb).value) {
                ...
                if (0 < d.Te) {
                    var e = (d.ji + 1) % d.Te;
                    d.ji = e;
                    d.Ti ? (d = d.Zh[e], d.reset(b, c, null)) : (d.Ti = e == d.Te - 1, d = d.Zh[e] = new bc(b, c))
                } else d = new bc(b, c);
                ec(a, d)
            }
        },
    ...
    */
    var mc = [],
        nc = function() {}; - 1 === mc.indexOf(nc) && mc.push(nc);
    var oc = function(a, b) {
    ...
    var rc = Ob() ? !1 : B("Opera"),
        ...
        tc = B("Edge"),
        uc = tc || sc,
        vc = B("Gecko") && !(A(Kb().toLowerCase(), "webkit") && !B("Edge")) && !(B("Trident") || B("MSIE")) && !B("Edge"),
    ...
    var Lc = function(a, b) {
        ...
        Nc = function(a, b) {
            ...
            a: {
                ...
                if (c.querySelector && (c = c.querySelector("script[nonce]")) && (c = c.nonce || c.getAttribute("nonce")) && Mc.test(c)) break a;c = ""
            }
    ...
    var Qc = function(a) {
        ...
        Tc = function(a, b) {
            var c = b[1],
                d = Vc(a, String(b[0]));
            c && ("string" === typeof c ? d.className = c : Array.isArray(c) ? d.className = c.join(" ") : Sc(d, c));
    ...
    var C = window,
        ...
        gd = function(a, b, c) {
            if (a)
                if (dd(a)) {
                    ...
                    for (d in D("object" === typeof a, "objectForEach was called with a non object value"), c = c || a, a) fd(a, d) && void 0 !== a[d] && b.call(c,
                        a[d], d)
        },
        hd = /&/g,
        id = /</g,
        ...
        ld = /'/g,
        md = function(a) {
            return String(a).replace(hd, "&amp;").replace(id, "&lt;").replace(jd, "&gt;").replace(kd, "&quot;").replace(ld, "&#39;")
        },
        nd = function() {
            var a;
    ...
    var qd = function(a, b, c) {
        ...
        rd = new RegExp(/^/.source + /([a-zA-Z][-+.a-zA-Z0-9]*:)?/.source + /(\/\/[^\/?#]*)?/.source + /([^?#]*)?/.source + /(\?([^#]*))?/.source + /(#((#|[^#])*))?/.source + /$/.source),
        sd = /[\ud800-\udbff][\udc00-\udfff]|[^!-~]/g,
        td = new RegExp(/(%([^0-9a-fA-F%]|[0-9a-fA-F]([^0-9a-fA-F%])?)?)*/.source + /%($|[^0-9a-fA-F]|[0-9a-fA-F]($|[^0-9a-fA-F]))/.source,
            "g"),
        ud = /%([a-f]|[0-9a-fA-F][a-f])/g,
        vd = /^(https?|ftp|file|chrome-extension):$/i,
        wd = function(a) {
            a = String(a);
            a = a.replace(sd, function(e) {
                try {
        ...
        xd = function(a) {
            return a.Td + (0 < a.query.length ? "?" + a.query.join("&") : "") + (0 < a.Sb.length ? "#" + a.Sb.join("&") : "")
        },
        yd = function(a, b) {
            var c = [];
            if (a)
        ...
        zd = new RegExp(/\/?\??#?/.source +
            "(" + /[\/?#]/i.source + "|" + /[\uD800-\uDBFF]/i.source + "|" + /%[c-f][0-9a-f](%[89ab][0-9a-f]){0,2}(%[89ab]?)?/i.source + "|" + /%[0-9a-f]?/i.source + ")$", "i"),
        Ad = function(a, b) {
            var c = wd(b);
            b = c.Td;
            ...
            var d = "";
            2E3 < b.length && (d = b, b = b.substr(0, 2E3), b = b.replace(zd, ""), d = d.substr(b.length));
    ...
    var Gd = /^https?:\/\/(?:\w|[\-\.])+\.google\.(?:\w|[\-:\.])+(?:\/[^\?#]*)?\/u\/(\d)\//,
        ...
        Id = function() {
            ...
            "string" === typeof a && 254 < a.length && (a = null);
            null == a && (b = window.location.href, a = qd(b, "authuser") ||
                null, null == a && (a = (a = b.match(Gd)) ? a[1] : null));
    ...
    var Ld, Md, Nd = void 0,
        ...
        oe = function(a) {
            ...
            b = b.replace(ee, "0");
            b = b.replace(fe, "0");
            if (ge.test(b) || he.test(b) || ie.test(b) || je.test(b) || !b || (b = b.replace(ke, ""))) return !1;
            a = a.replace(le, "\\u2028").replace(me,
                "\\u2029");
            b = void 0;
            try {
                b = Nd ? [Od(a)] : eval("(function (var_args) {\n  return Array.prototype.slice.call(arguments, 0);\n})(\n" + a + "\n)")
            } catch (c) {
                return !1
            }
        ...
        pe = function() {
            ...
            if ((void 0 === Ld || void 0 === Nd || Md !== a) && -1 !== Md) {
                ...
                try {
                    try {
                        Nd = !!p.JSON && '{"a":[3,true,"1970-01-01T00:00:00.000Z"]}' === p.JSON.stringify.call(p.JSON, {
                            a: [3, !0, new Date(0)],
                            c: function() {}
                        }) && !0 === Od("true") && 3 === Od('[{"a":3}]')[0].a
                    } catch (b) {}
                    Ld = Nd &&
                        !Od("[00]") && !Od('"\u0007"') && !Od('"\\0"') && !Od('"\\v"')
                } finally {
        ...
        se = !Date.prototype.toISOString || "function" !== typeof Date.prototype.toISOString || "1970-01-01T00:00:00.000Z" !== (new Date(0)).toISOString(),
        te = function() {
            var a = Date.prototype.getUTCFullYear.call(this);
            return [0 > a ? "-" + String(1E6 - a).substr(1) : 9999 >= a ? String(1E4 + a).substr(1) : "+" + String(1E6 + a).substr(1),
                "-", String(101 + Date.prototype.getUTCMonth.call(this)).substr(1), "-", String(100 + Date.prototype.getUTCDate.call(this)).substr(1), "T", String(100 + Date.prototype.getUTCHours.call(this)).substr(1), ":", String(100 + Date.prototype.getUTCMinutes.call(this)).substr(1), ":", String(100 + Date.prototype.getUTCSeconds.call(this)).substr(1), ".", String(1E3 + Date.prototype.getUTCMilliseconds.call(this)).substr(1), "Z"
            ].join("")
        };
    ...
    var we = function(a, b, c) {
        ...
        for (e = 0; 80 > e; e++) {
            ...
            else 60 > e ? (f = c & g | h & (c | g),
                m = 2400959708) : (f = c ^ g ^ h, m = 3395469782);
    ...
    ve.prototype.update = function(a, b) {
        if (null != a) {
            ...
            for (var c = b - this.blockSize, d = 0, e = this.og, f = this.wd; d < b;) {
                if (0 == f)
                    for (; d <= c;) we(this, a, d), d += this.blockSize;
                if ("string" === typeof a)
                    for (; d < b;) {
    ...
    ve.prototype.digest = function() {
        var a = [],
            b = 8 * this.hc;
        56 > this.wd ? this.update(this.Df, 56 - this.wd) : this.update(this.Df, this.blockSize - (this.wd - 56));
    ...
    k.digestString = function() {
        for (var a = this.digestByteArray(), b = "", c = 0; c < a.length; c++) b += "0123456789ABCDEF".charAt(Math.floor(a[c] / 16)) + "0123456789ABCDEF".charAt(a[c] % 16);
        return b
    };
    var ye = C.crypto,
        ze = !1,
    ...
    ze || (De = 1E6 * (screen.width * screen.width + screen.height), Ee = Ge(ad.cookie + "|" + ad.location + "|" + (new Date).getTime() + "|" + Math.random()), Ae = ya("random/maxObserveMousemove") || 0, 0 != Ae && Ed(C, "mousemove", Fe));
    var He = function() {
            var a = Kd.onl;
            if (!a) {
                a = nd();
    ...
    var Le = {
        ...
        Oe = function(a, b) {
            var c = 0;
            do var d = b.id || ["I", Ne++, "_", (new Date).getTime()].join(""); while (a.getElementById(d) && 5 > ++c);
        ...
        Qe = function(a, b, c, d) {
            ...
            g = g || "";
            !g && c && (g = qd(a.location.href, "_gfid", "") || qd(a.location.href, "id", ""), g = Pe(g, qd(a.location.href, "pfname", "")));
            g || (c = qe(qd(a.location.href, "jcp", ""))) && "object" == typeof c && (g = Pe(c.id, c.pfname));
            h.pfname = g;
            ...
            if (!g) {
                if (!(g =
                    ...
                    if (ze) {
                        ...
                        m = Number("0." + m[0])
                    } else m = Ce, m += parseInt(Ee.substr(0, 20), 16), Ee = Ge(Ee), m /= De + Math.pow(16, 20);
                    g = g(l.call(c, 1E8 * m))
                }
                h.rpctoken = g
            }
        ...
        Se = function(a, b, c, d, e) {
            ...
            var f, g = Ie(d, c),
                h = g ? Je(d) : "";
            try {
                document.all && (f = a.createElement('<iframe frameborder="' + md(String(c.frameborder)) + '" scrolling="' + md(String(c.scrolling)) + '" ' + h + ' name="' + md(String(c.name)) + '"/>'))
            } catch (m) {} finally {
                f || (f = (a ? new $c(Zc(a)) : Aa || (Aa = new $c)).xk("IFRAME"), g && (f.onload = function() {
                    f.onload = null;
                    g.call(this)
                }, Ke(d)))
            }
            ...
            for (var l in c) a =
                c[l], "style" === l && "object" === typeof a ? od(a, f.style) : Me[l] || f.setAttribute(l, String(a));
    ...
    var Te = /^:[\w]+$/,
        ...
        We = function(a) {
            var b = a;
            Te.test(a) && (b = ya("iframes/" + b.substring(1) +
                "/url"), D(!!b, "Unknown iframe url config for - " + a));
        ...
        Xe = function(a, b, c) {
            ...
            if (c.forcePost || h && 2E3 < a.length) {
                ...
                f = [];
                for (h = 0; h < g.length; h++) m = g[h].split("=", 2), f.push([decodeURIComponent(m[0]), decodeURIComponent(m[1])]);
                c.query = [];
                g = xd(c);
                ...
                oc(c,
                    "FORM").action = Cb(e);
                for (e = 0; e < f.length; e++) g = d.createElement("input"), g.type = "hidden", g.name = f[e][0], g.value = f[e][1], c.appendChild(g);
                b.appendChild(c);
                c.submit();
    ...
    var Ye = function(a) {
        ...
        af = function(a, b, c) {
            if (b && "object" === typeof b)
                for (var d in b) !Object.prototype.hasOwnProperty.call(b, d) || c && "___goc" === d && "undefined" === typeof b[d] || (a[d] && b[d] && "object" === typeof a[d] && "object" === typeof b[d] && !$e(a[d]) && !$e(b[d]) ? af(a[d], b[d]) : b[d] && "object" ===
                    typeof b[d] ? (a[d] = $e(b[d]) ? [] : {}, af(a[d], b[d])) : a[d] = b[d])
        },
        bf = function(a) {
            if (a && !/^\s+$/.test(a)) {
        ...
        df = function(a) {
            ...
            for (e = 0; e < d.length; ++e) d[e].getAttribute("gapi_processed") ||
                (d[e].setAttribute("gapi_processed", !0), (f = d[e]) ? (g = f.nodeType, f = 3 == g || 4 == g ? f.nodeValue : f.textContent || "") : f = void 0, (f = bf(f)) && b.push(f));
            a && cf(c, a);
            d = Ye("cd");
            a = 0;
    ...
    var ef = function() {
        ...
        a && (a.googleapis && !a["googleapis.config"] && (a["googleapis.config"] = a.googleapis), cd(Kd, "ci", []).push(a), window.__GOOGLEAPIS = void 0)
    };
    ef && ef();
    df();
            ...
            case "object":
                if (a) {
                    ...
                    switch (c) {
                        ...
                        default:
                            return d = "Object", c && c.constructor && (d = lf(c.constructor)), "function" === typeof a.toString && a.toString !== Object.prototype.toString ? d + "(" + String(a) + ")" : "(object " + d + ")"
                    }
                }
                break;
            case "function":
    ...
    var mf = function(a, b) {
            a.Gi = "function" === typeof b ? b : function() {
                return b
            };
            return a
        }(function(a) {
    ...
    var tf = function(a) {
        ...
        var c = a.priority,
            ...
            e = 0 < d ? b.Cb[d - 1] : null;
        e && e.priority <= c && w(!1, "two delegates registered with same priority (%s): %s and %s", c, e.Xe || e.instance, a.Xe || a.instance);
        b.Cb.splice(d, 0, a)
    };
    var sf = new function() {
        var a = this;
    ...
    var uf = {
        ...
        vf = /^(?!-*(?:expression|(?:moz-)?binding))(?:[.#]?-?(?:[_a-z0-9-]+)(?:-[_a-z0-9-]+)*-?|-?(?:[0-9]+(?:\.[0-9]*)?|\.[0-9]+)(?:[a-z]{1,2}|%)?|!important|)$/i,
        wf = function(a) {
    ...
    Bf.prototype.remove = function() {
        var a = null;
        this.Zc && (a = this.Zc, this.Zc = this.Zc.next, this.Zc || (this.ag = null), a.next = null);
        return a
    };
    var Cf = new xf(function() {
            return new Df
        }, function(a) {
            return a.reset()
        }),
    ...
    var Hf, If = !1,
        ...
        Kf = function() {
            if (p.Promise && p.Promise.resolve) {
                ...
                var b = Mf;
                "function" !== typeof p.setImmediate || p.Window && p.Window.prototype && (Ob() || !B("Edge")) && p.Window.prototype.setImmediate == p.setImmediate ? (yf || (yf = zf()), yf(b)) : p.setImmediate(b)
            }
        },
        Mf = function() {
            ...
            return new E(function(b, c) {
                ...
                if (d)
                    for (var f = function(m, q) {
                            ...
                            c(m)
                        }, h = 0, l; h < a.length; h++) l = a[h], Uf(l, wa(f, h), g);
                else b(e)
            })
        },
        Wf =
            ...
            return new E(function(b) {
                ...
                if (c)
                    for (var e = function(h, l, m) {
                            ...
                            0 == c && b(d)
                        }, f = 0, g; f < a.length; f++) g = a[f], Uf(g, wa(e, f, !0), wa(e, f, !1));
                else b(d)
            })
        };
    ...
    var Zf = function(a, b) {
            if (0 == a.Ba)
                if (a.Ha) {
                    var c = a.Ha;
                    if (c.Xb) {
                        for (var d = 0, e = null, f = null, g = c.Xb; g && (g.Sd || (d++, g.child == a && (e = g), !(e && 1 < d))); g = g.next) e || (f = g);
                        e && (0 == c.Ba && 1 == d ? Zf(c, b) : (f ? (d = f, w(c.Xb), w(null != d), d.next == c.hd && (c.hd = d), d.next = d.next.next) : $f(c), ag(c, e, 3, b)))
                    }
                    a.Ha = null
                } else Of(a, 3, b)
        },
    ...
    var Of = function(a, b, c) {
            0 == a.Ba && (a === c && (b = 3, c = new TypeError("Promise cannot resolve to itself")), a.Ba = 1, Tf(c, a.sm, a.tm, a) || (a.Ua = c, a.Ba = b, a.Ha = null, bg(a), 3 != b || c instanceof Pf || cg(a, c)))
        },
        Tf = function(a, b, c, d) {
            if (a instanceof E) return null != b && Ia(b, "opt_onFulfilled should be a function."), null != c && Ia(c, "opt_onRejected should be a function. Did you pass opt_context as the second argument instead of the third?"), Yf(a, Sf(b || Ic, c || null, d)), !0;
    ...
    var gg, hg, ig, jg = /^[\w\.\-]*$/,
        ...
        ng = function(a, b, c) {
            a = gg[a];
            if (!a) return [];
            for (var d = [], e = 0; e < a.length; e++) d.push(F(a[e].call(c,
                b, c)));
            return d
        },
        pg = function(a, b, c) {
    ...
    ih.prototype.Vk = function(a) {
        var b = String(a.data);
        ah.debug("gapix.rpc.receive(" + eh + "): " + (!b || 512 >= b.length ? b : b.substr(0, 512) + "... (" + b.length + " bytes)"));
        var c = 0 !== b.indexOf("!_");
        c || (b = b.substring(2));
        var d = kh(b);
        if (!c && !d) {
    ...
    var hh = function(a, b, c, d) {
        var e = kh(c) ? "" : "!_";
        ah.debug("gapix.rpc.send(" + eh + "): " + (!c || 512 >= c.length ? c : c.substr(0, 512) + "... (" + c.length + " bytes)"));
        a.wj(b, e + c, d)
    };
    ...
    var lh = 0,
        ...
        dh = function(a, b) {
            ...
            for (b = b.split("/"); b.length;) {
                ...
                if (".." === c) a = a == a.parent ? a.opener : a.parent;
                    ...
                    if (a =
                        a.frames[c], !("postMessage" in a)) throw Error("Not a window");
                } else return null
            }
            return a
        },
        ...
        Gh = function(a) {
            th[a] || (th[a] = C.setTimeout(function() {
                th[a] = !1;
                Fh(a)
            }, 0))
        },
        ...
        zh =
        function() {
            for (var a = ya("rpc/residenceSec") || 60, b = (new Date).getTime() / 1E3, c, d = 0; c = mh[d]; ++d) {
                var e = c.rpc;
                if (!e || 0 < a && b - c.timestamp > a) mh.splice(d, 1), --d;
                    ...
                    var f = e.s,
                        g = oh[f] || oh["*"];
                    if (g)
                        if (mh.splice(d, 1), --d, e.origin = c.origin, c = Eh(e), e.callback = c, g.Ca(e)) {
        ...
        Dh = function(a, b, c, d) {
                ...
                if (x.Rg) {
                    if (!(l = nh[a].am)) {
                        ...
                        for (var z = C.parent; z !== C.top;) {
                            var R = z.parent;
                            if (!q--) {
                                for (var Ca = null, Dc = R.frames.length, ne = 0; ne < Dc; ++ne) R.frames[ne] == z && (Ca = ne);
                                l.unshift("{" + Ca + "}")
                            }
                            z = R
                        }
            ...
            g && x ? (m = wh, x.Rg &&
                (m = xh(x)), Bh["_" + ++lh] = [g, m], g = lh) : g = null;
            f = {
                s: e,
                f: h,
                r: q,
    ...
    if ("function" === typeof C.postMessage || "object" === typeof C.postMessage) vh = new ih, Ah("__cb", Ch, function() {
        return !0
    ...
    !B("Android") || Qb();
    Qb();
    var Lh = B("Safari") && !(Qb() || (Ob() ? 0 : B("Coast")) || (Ob() ? 0 : B("Opera")) || (Ob() ? 0 : B("Edge")) || (Ob() ? Nb("Microsoft Edge") : B("Edg/")) || (Ob() ? Nb("Opera") : B("OPR")) || B("Firefox") || B("FxiOS") || B("Silk") || B("Android")) && !(pc() || B("iPad") || B("iPod"));
    var Nh = function(a, b, c) {
        ...
        Mh = function(a) {
            if (!a.closed && a.document && a.document.body)
                if (a = a.document.body, w(null != a, "goog.dom.setTextContent expects a non-null value for node"), "textContent" in a) a.textContent = "Please close this window.";
    ...
    k.unregister = function(a, b) {
        var c = Oh(this, a),
            d = gg[c];
        d && (b ? (b = ed.call(d, b), 0 <= b && d.splice(b, 1)) : d.splice(0, d.length), 0 == d.length && (b = ed.call(this.Cb, a), 0 <= b && this.Cb.splice(b, 1), delete oh[yh(c).name]))
    };
    k.Qk = function() {
        return this.Cb
    };
    ...
    var Ph = function(a) {
        var b = {};
        if (a)
            for (var c in a) fd(a, c) && fd(uf, c) && vf.test(a[c]) && (b[c] = a[c]);
        return b
    };
    k = I.prototype;
    ...
    k.Zl = function(a) {
        ...
        (b = this.getIframeEl()) && a && "object" === typeof a && (fd(a, "height") && (a.height = wf(a.height)), fd(a, "width") && (a.width = wf(a.width)), od(a, b.style))
    };
    k.tk = function(a) {
        ...
        if (b = this.Sa.i.controller) c = {}, c.frameName = this.getFrameName(), J(b, "_g_disposeControl", c);
    ...
    k.wk = function(a) {
        ...
        for (var b = a.rpcAddr, c = (this.qb() + "/" + b).split("/"), d = this.getContext().getWindow(), e;
    ...
    k.uk = function(a) {
        ...
        else(D(tg.test(b.getOrigin()), "Illegal origin for connected iframe - " + b.getOrigin()), c = this.getContext().lb[b.getFrameName()], c) ? yg(b) && (c.bc(), J(c, "_g_rpcReady")) : (b = Rg(Ug(Tg(Sg(new H, b.qb()), b.Gb()), b.getOrigin()), b.getFrameName()).bc(yg(b)).Vc(zg(b)), c = Qh(this.getContext(), b.value()));
        b = this.getContext();
        var d = a.i.role;
        a = a.i.data;
        Rh(b);
    ...
    var Qh = function(a, b) {
        ...
        var f = b.Gb(),
            g = zg(b);
        g || (g = (g = b.getIframeEl()) && (g.getAttribute("data-postorigin") || g.src) || b.getUrl(), g = qd(g, "rpctoken"));
    ...
    K.prototype.Ah = function(a) {
        Rg(a, null);
        var b = a.getId();
        !b || jg.test(b) && !this.getWindow().document.getElementById(b) || (ah.log("Ignoring requested iframe ID - " + b), a.i.id = null)
    };
    var bi = function(a, b) {
        var c = qd(a, b);
        c || (c = qe(qd(a, "jcp", ""))[b]);
    ...
    K.prototype.openChild = function(a) {
        ...
        d || (d = b.i.where, D(!!d, "No location for new iframe"), c = Xe(c, d, a), b.i.iframeEl = c, d = c.getAttribute("id"));
        Sg(b, d).i.id = d;
        Ug(b, ff(b.i.eurl || ""));
    ...
    var di = function(a, b, c) {
        ...
        ei = function(a, b, c) {
            ...
            if (d) {
                ...
                d instanceof I ?
                    (e = d, b.i.relayOpen = 0) : 0 < Number(d) && (b.i.relayOpen = Number(d) - 1);
                if (e) {
                    D(!!e.sj, "Relaying iframe open is disabled");
                    if (d = b.getStyle())
                        if (d = Uh[d]) Vg(b, a), d(b.value()), Vg(b, null);
    ...
    K.prototype.open = function(a, b) {
        ...
        if (null != Og(c)) {
            var e = setTimeout(function() {
                    ...
                    d.reject({
                        timeout: "Exceeded time limit of :" + Og(c) + "milliseconds"
                    })
                }, Og(c)),
                f = d.resolve;
        ...
        c.i.waitForOnload && Cg(Mg(c), function() {
            d.resolve(g)
        });
        var g =
            this.openChild(a);
    ...
    var gi = function(a, b) {
        ...
        return F(d).then(function(e) {
            return e && c ? (b.tj && b.tj.call(a, b.params), e = b.sender ? b.sender(b.params) : J(c, b.message, b.params), b.ym ? e.then(function() {
                return !0
            }) : !0) : !1
        })
    };
    ...
    K.prototype.addOnConnectHandler = function(a, b, c, d) {
        Rh(this);
        "object" === typeof a ? (b = new Eg(a), c = b.i.role || "") : (b = Hg(Gg(Fg(a), b).De(c), d), c = a);
        d = this.ug[c] || [];
        a = !1;
        for (var e = 0; e < d.length && !a; e++) Sh(this.lb[d[e].lf.getFrameName()], d[e].data, [b]), a = b.i.runOnce;
        c = cd(this.Yg, c, []);
    ...
    K.prototype.removeOnConnectHandler = function(a, b) {
        a = cd(this.Yg, a, []);
        if (b)
            for (var c = !1, d = 0; !c && d < a.length; d++) a[d].i.handler === b && (c = !0, a.splice(d, 1));
    ...
    var wi = function(a) {
        ...
        for (var c = a.xm, d = 0, e = 0; e < b.length;) c[d++] = b[e] << 24 | b[e + 1] << 16 | b[e + 2] << 8 | b[e + 3], e = 4 * d;
        for (b = 16; 64 > b; b++) {
            e = c[b - 15] | 0;
            d = c[b - 2] | 0;
        ...
        f = a.na[7] | 0;
        for (b = 0; 64 > b; b++) {
            var z = ((d >>> 2 | d << 30) ^ (d >>> 13 | d << 19) ^ (d >>> 22 | d << 10)) + (d & e ^ d & h ^ e & h) | 0;
            g = m & q ^ ~m & x;
    ...
    zi.prototype.Zd = function() {
        if (this.Cf)
            for (; this.Cf.length;) this.Cf.shift()()
    };
    var Ai = function(a, b) {
        this.type = a;
    ...
    var Bi = function() {
        ...
        try {
            p.addEventListener("test", function() {}, b), p.removeEventListener("test", function() {}, b)
        } catch (c) {}
        return a
    }();
    var Ci = function(a, b) {
    ...
    Ci.prototype.init = function(a, b) {
        ...
        d ? (this.clientX = void 0 !== d.clientX ? d.clientX : d.pageX, this.clientY = void 0 !== d.clientY ? d.clientY : d.pageY, this.screenX = d.screenX || 0, this.screenY =
            d.screenY || 0) : (this.offsetX = wc || void 0 !== a.offsetX ? a.offsetX : a.layerX, this.offsetY = wc || void 0 !== a.offsetY ? a.offsetY : a.layerY, this.clientX = void 0 !== a.clientX ? a.clientX : a.pageX, this.clientY = void 0 !== a.clientY ? a.clientY : a.pageY, this.screenX = a.screenX || 0, this.screenY = a.screenY || 0);
    ...
    Ii.prototype.add = function(a, b, c, d, e) {
        ...
        var g = Ji(a, b, d, e); - 1 < g ? (b = a[g], c || (b.Re = !1)) : (b = new Gi(b, this.src, f, !!d, e), b.Re = c, a.push(b));
        return b
    };
    ...
    var Li = "closure_lm_" + (1E6 * Math.random() | 0),
        ...
        Pi = function(a, b, c, d, e) {
            ...
            else c = Qi(c), a && a[Ei] ? a.listen(b, c, t(d) ? !!d.capture : !!d, e) : Ri(a, b, c, !1, d, e)
        },
        Ri = function(a, b, c, d, e, f) {
            ...
            if (!c.proxy) {
                ...
                d.src = a;
                d.listener = c;
                if (a.addEventListener) Bi || (e = g), void 0 === e && (e = !1), a.addEventListener(b.toString(),
                    d, e);
        ...
        Oi = function(a, b, c, d, e) {
            if (Array.isArray(b))
                for (var f = 0; f < b.length; f++) Oi(a, b[f], c, d, e);
            else c = Qi(c), a && a[Ei] ? Wi(a, b, c, t(d) ? !!d.capture : !!d, e) : Ri(a, b, c, !0, d, e)
        },
        Xi = function(a,
            b, c, d, e) {
            if (Array.isArray(b))
                for (var f = 0; f < b.length; f++) Xi(a, b[f], c, d, e);
            else d = t(d) ? !!d.capture : !!d, c = Qi(c), a && a[Ei] ? a.Fb.remove(String(b), c, d, e) : a && (a = Si(a)) && (b = a.Hg(b, c, d, e)) && Yi(b)
        },
        Yi = function(a) {
            if ("number" !== typeof a && a && !a.Be) {
                ...
                if (b && b[Ei]) Ki(b.Fb, a);
                    ...
                    Ni--;
                    (c = Si(b)) ? (Ki(c, a), 0 == c.Ke && (c.src = null, b[Li] = null)) :
                    Hi(a)
                }
            }
        },
    ...
    k.dispatchEvent = function(a) {
        ...
        a.xe || (g = a.currentTarget = b, e = bj(g, d, !0, a) && e, a.xe || (e = bj(g, d, !1, a) && e));
        if (c)
            for (f = 0; !a.xe && f < c.length; f++) g = a.currentTarget = c[f], e = bj(g, d, !1, a) &&
                e;
        return e
    };
    k.Zd = function() {
    ...
    var aj = function(a) {
        w(a.Fb, "Event target is not initialized. Did you call the superclass (goog.events.EventTarget) constructor?")
    };
    var cj = function() {};
    ...
    kj.prototype.abort = function() {
        ...
        this.yh = new Headers;
        this.status = 0;
        this.Wd && this.Wd.cancel("Request was aborted.").catch(function() {
            var b = a.Ea;
    ...
    kj.prototype.Zk = function(a) {
        if (this.Tb && (this.Ze = a, this.Jd || (this.status = this.Ze.status, this.statusText = this.Ze.statusText, this.Jd = a.headers, this.readyState = 2, lj(this)), this.Tb && (this.readyState = 3, lj(this), this.Tb)))
            if ("arraybuffer" === this.responseType) a.arrayBuffer().then(this.Xk.bind(this), this.ff.bind(this));
    ...
    k.getResponseHeader = function(a) {
        return this.Jd ? this.Jd.get(a.toLowerCase()) || "" : ((a = this.Ea) && jc(a, Xb, "Attempting to get response header but no headers have been received for url: " + this.kb), "")
    };
    k.getAllResponseHeaders = function() {
        if (!this.Jd) {
            var a = this.Ea;
            a && jc(a, Xb, "Attempting to get all response headers but no headers have been received for url: " + this.kb);
            return ""
        }
        a = [];
        for (var b = this.Jd.entries(), c = b.next(); !c.done;) c = c.value, a.push(c[0] + ": " + c[1]), c = b.next();
        return a.join("\r\n")
    };
    k.Dh = function(a) {
        this.Gc = a
    ...
    */
        ...
        tj = function(a) {
            ...
            for (var d = c = !1; a.Rf.length && !a.mg;) {
                ...
                if (f = a.ie ? g : f) try {
                    ...
                    if (Nf(b) || "function" === typeof p.Promise && b instanceof p.Promise) d = !0, a.mg = !0
                } catch (l) {
                    b =
                        l, a.ie = !0, Aj(a) || (c = !0)
                }
            ...
            a.Ua = b;
            d && (h = u(a.hi, a, !0), d = u(a.hi, a, !1), b instanceof pj ? (xj(b, h, d), b.Yh = !0) : b.then(h, d));
    ...
    var Hj = function(a) {
            ...
            e.onload = e.onreadystatechange = function() {
                e.readyState && "loaded" != e.readyState && "complete" != e.readyState || (Ej(e, b.Nm || !1, h), g.callback(null))
            };
            e.onerror = function() {
                Ej(e, !0, h);
                qj(g, new Fj(0, "Error while loading script " +
                    d))
            };
            f = b.attributes || {};
            $a(f, {
    ...
    Mj.prototype.send = function(a, b, c, d) {
        if (this.u) throw Error("[goog.net.XhrIo] Object is active with another request=" + this.wf + "; newUri=" + a);
        ...
        this.Ol && "onprogress" in this.u && (this.u.onprogress = u(function(g) {
            this.qj(g, !0)
        }, this), this.u.upload && (this.u.upload.onprogress = u(this.qj, this)));
        try {
            lc(this.Ea,
                Pj(this, "Opening Xhr")), this.Ng = !0, this.u.open(b, String(a), !0), this.Ng = !1
        } catch (g) {
        ...
        b = ha(c);
        for (d = b.next(); !d.done; d = b.next()) c = ha(d.value), d = c.next().value, c = c.next().value, this.u.setRequestHeader(d, c);
        ...
        if ("setTrustToken" in this.u && this.Qh) try {
            this.u.setTrustToken(this.Qh)
        } catch (g) {
            lc(this.Ea, Pj(this, "Error SetTrustToken: " +
                g.message))
        }
        try {
            Qj(this), 0 < this.Md && (this.Yf = Rj(this.u), lc(this.Ea, Pj(this, "Will abort after " + this.Md + "ms if incomplete, xhr2 " + this.Yf)), this.Yf ? (this.u.timeout = this.Md, this.u.ontimeout = u(this.Ie, this)) : this.Vf = Ij(this.Ie, this.Md, this)), lc(this.Ea, Pj(this, "Sending request")), this.qf = !0, this.u.send(a), this.qf = !1
        } catch (g) {
    ...
    Mj.prototype.Ie = function() {
        "undefined" != typeof ra && this.u && (this.me = "Timed out after " + this.Md + "ms, aborting", lc(this.Ea, Pj(this, this.me)), this.dispatchEvent("timeout"), this.abort(8))
    };
    ...
    Mj.prototype.abort = function() {
        this.u && this.mc && (lc(this.Ea, Pj(this, "Aborting")), this.mc = !1, this.Nc = !0, this.u.abort(), this.Nc = !1, this.dispatchEvent("complete"), this.dispatchEvent("abort"), Tj(this))
    };
    Mj.prototype.Zd = function() {
        this.u && (this.mc && (this.mc = !1, this.Nc = !0, this.u.abort(), this.Nc = !1), Tj(this, !0));
        Mj.Wc.Zd.call(this)
    };
    ...
    var Uj = function(a) {
        if (a.mc && "undefined" != typeof ra)
            if (a.dg[1] && 4 == Vj(a) && 2 == a.getStatus()) lc(a.Ea, Pj(a, "Local request error detected and ignored"));
    ...
    var Xj = function(a) {
        ...
        Zj = function(a, b, c) {
            if (a.forEach && "function" == typeof a.forEach) a.forEach(b, c);
                ...
                for (var d = Yj(a), e = Xj(a), f = e.length, g = 0; g < f; g++) b.call(c, e[g], d && d[g], a)
        };
    var ak = function(a) {
        ...
        if (a instanceof ak) {
            ...
            ck(this);
            this.Kc = a
        } else a && (b = String(a).match(Kj)) ? (this.Bb = !1, bk(this, b[1] || "", !0), a = b[2] || "", ck(this), this.Xc = gk(a), dk(this, b[3] || "", !0), ek(this, b[4]), this.setPath(b[5] || "", !0), fk(this, b[6] || "", !0), a = b[7] || "", ck(this), this.Kc = gk(a)) : (this.Bb = !1, this.tb = new hk(null, this.Bb))
    };
    ak.prototype.toString = function() {
        ...
        b && a.push(ik(b, jk, !0), ":");
        var c = this.Ga;
        if (c || "file" == b) a.push("//"), (b = this.Xc) && a.push(ik(b, jk, !0), "@"), a.push(encodeURIComponent(String(c)).replace(/%25([0-9a-fA-F]{2})/g, "%$1")), c = this.Ub, null != c && a.push(":", String(c));
        if (c = this.getPath()) this.Ga && "/" != c.charAt(0) && a.push("/"), a.push(ik(c, "/" == c.charAt(0) ? kk : lk, !0));
    ...
    var M = function(a) {
        ...
        ik = function(a, b, c) {
            return "string" === typeof a ? (a = encodeURI(a).replace(b, qk), c && (a = a.replace(/%25([0-9a-fA-F]{2})/g, "%$1")), a) : null
        },
        qk = function(a) {
            a = a.charCodeAt(0);
        ...
        rk = function(a) {
            a.qa || (a.qa = new Map, a.Na = 0, a.nb && Lj(a.nb, function(b, c) {
    ...
    hk.prototype.remove = function(a) {
        rk(this);
        a = this.ob(a);
        return this.qa.has(a) ? (this.nb = null, this.Na = Ga(this.Na) - this.qa.get(a).length, this.qa.delete(a)) : !1
    };
    ...
    k.setValues = function(a, b) {
        this.remove(a);
        0 < b.length && (this.nb = null, this.qa.set(this.ob(a), Sa(b)), this.Na = Ga(this.Na) + b.length)
    };
    k.toString = function() {
    ...
    k.Fh = function(a) {
        a && !this.Bb && (rk(this), this.nb = null, this.qa.forEach(function(b, c) {
            var d = c.toLowerCase();
    ...
    k.extend = function(a) {
        for (var b = 0; b < arguments.length; b++) Zj(arguments[b], function(c, d) {
            this.add(d, c)
        }, this)
    };
    var uk = {
        ...
        vk = function(a) {
            for (var b in uk)
                if (uk[b].id === a) return a = uk[b], {
                    firebaseEndpoint: a.af,
                    secureTokenEndpoint: a.Of,
    ...
    var angular, yk = function() {
        ...
        Bk = function(a, b) {
            var c = [],
                d;
            for (d in a) d in b ? typeof a[d] != typeof b[d] ? c.push(d) : "object" == typeof a[d] && null != a[d] && null != b[d] ? 0 < Bk(a[d], b[d]).length && c.push(d) : a[d] !== b[d] && c.push(d) : c.push(d);
            for (var e in b) e in a || c.push(e);
            return c
        },
        Dk = function() {
            var a = xk();
            a = "Chrome" != Ck(a) ? null : (a = a.match(/\sChrome\/(\d+)/i)) && 2 == a.length ? parseInt(a[1], 10) : null;
        ...
        Gk = function(a, b, c) {
            ...
            c = b.noreferrer;
            if (f && c) {
                if (g) throw Error("Cannot use the noreferrer option on a page that sets a referrer-policy of `unsafe-url` in modern browsers!");
                c = !1
            }
            e = b.target || e.target;
            f = [];
            ...
            var h = f.join(",");
            (pc() || B("iPad") || B("iPod")) && a.navigator && a.navigator.standalone && e && "_self" != e ? (h = Vc(document, "A"), Lc(h, d), h.target =
                e, c && (h.rel = "noreferrer"), d = document.createEvent("MouseEvent"), d.initMouseEvent("click", !0, !0, a, 1), h.dispatchEvent(d), h = {}) : c ? (h = Oc("", a, e, h), d = Cb(d), h && (uc && A(d, ";") && (d = "'" + d.replace(/'/g, "%27") + "'"), h.opener = null, "" === d && (d = "javascript:''"), a = new kb(ib, "b/12014412, meta tag with sanitized URL"), zb.test(d) && (-1 != d.indexOf("&") && (d = d.replace(tb, "&amp;")), -1 != d.indexOf("<") && (d = d.replace(ub, "&lt;")), -1 != d.indexOf(">") && (d = d.replace(vb, "&gt;")), -1 != d.indexOf('"') && (d = d.replace(wb, "&quot;")), -1 != d.indexOf("'") &&
                (d = d.replace(xb, "&#39;")), -1 != d.indexOf("\x00") && (d = d.replace(yb, "&#0;"))), a = Kc(a, '<meta name="referrer" content="no-referrer"><meta http-equiv="refresh" content="0; url=' + d + '">'), (d = h.document) && d.write && (d.write(Tb(a)), d.close()))) : ((h = Oc(d, a, e, h)) && b.noopener && (h.opener = null), h && b.noreferrer && (h.opener = null));
            if (h) try {
                h.focus()
            } catch (l) {}
            return h
        ...
        Jk = function(a,
            ...
            for (var d = 0; d < a.length; d++) {
                var e = a[d];
                0 == e.indexOf("chrome-extension://") ? e = M(e).Ga == c && "chrome-extension" == b : "http" != b && "https" != b ? e = !1 : Ik.test(e) ? e = c == e : (e = e.split(".").join("\\."), e = (new RegExp("^(.+\\." + e + "|" + e + ")$", "i")).test(c));
                if (e) return !0
            }
            return !1
        },
        ...
        Mk = function() {
            var a = xk();
            return !("file:" !== Ok() && "ionic:" !== Ok() || !a.toLowerCase().match(/iphone|ipad|ipod|android/))
        },
        Pk = function() {
            var a = p.window;
            try {
        ...
        Rk = function() {
            return firebase.INTERNAL.hasOwnProperty("reactNative") ? "ReactNative" : firebase.INTERNAL.hasOwnProperty("node") ? "Node" : Qk() ? "Worker" : "Browser"
        },
        Sk = function() {
            var a = Rk();
        ...
        Ck = function(a) {
            ...
            if (!A(b, "safari/") || A(b, "chrome/") || A(b, "crios/") || A(b, "android"))
                if (!A(b, "chrome/") && !A(b, "crios/") || A(b, "edge/")) {
                    ...
                    if ((a = a.match(RegExp("([a-zA-Z\\d\\.]+)/[a-zA-Z\\d\\.]*$"))) &&
        ...
        Vk = function(a, b, c) {
            ...
            for (f = 0; f < c.length; f++) "undefined" !== typeof e[c[f]] && (delete e[c[f]], d.push(c[f]));
            d.sort();
            c = d;
            c.length || (c = ["FirebaseCore-web"]);
            d = Rk();
            return ("Browser" === d ? Ck(xk()) : "Worker" === d ? Ck(xk()) + "-" + d : d) + "/" + a + "/" + b + "/" + c.join(",")
        },
        xk = function() {
    ...
    fl.prototype.get = function() {
        var a = p.navigator;
        return (a && "boolean" === typeof a.onLine && (Yk() || "chrome-extension:" === Ok() || "undefined" !== typeof a.connection) ? a.onLine : 1) ? this.tl ? this.zl : this.Nj : Math.min(5E3, this.Nj)
    };
    var gl = function() {
            var a = p.document;
        ...
        hl = function() {
            var a = p.document,
                b = null;
            return gl() || !a ? F() : (new E(function(c) {
                b = function() {
    ...
    var O = function(a, b, c) {
        ...
        rl = function(a, b) {
            if (b)
                for (var c in b) b.hasOwnProperty(c) && O(a, c, b[c])
        },
        sl = function(a) {
            var b = {};
            rl(b, a);
    ...
    var vl = "oauth_consumer_key oauth_nonce oauth_signature oauth_signature_method oauth_timestamp oauth_token oauth_version".split(" "),
        ...
        function(a) {
            for (var b in xl)
                if (xl[b].providerId == a) return xl[b];
            return null
        };
    var P = function(a, b, c) {
        this.code = "auth/" + a;
    ...
    var Cl = function(a) {
        a = a || {};
        return a.type ? new Bl(a.type, a.eventId, a.urlResponse, a.sessionId, a.error && Al(a.error), a.postBody, a.tenantId) : null
    };
    var Dl = function(a) {
    ...
    var Gl = function(a) {
        var b = {},
            ...
            e = a.requestType;
        a = Fl(a.mfaInfo);
        if (!e || "EMAIL_SIGNIN" != e && "VERIFY_AND_CHANGE_EMAIL" != e && !c || "VERIFY_AND_CHANGE_EMAIL" == e && !d || "REVERT_SECOND_FACTOR_ADDITION" == e && !a) throw Error("Invalid checkActionCode response!");
        "VERIFY_AND_CHANGE_EMAIL" == e ? (b.fromEmail = c || null, b.previousEmail = c || null, b.email = d) : (b.fromEmail = d || null, b.previousEmail = d || null, b.email = c || null);
    ...
    var Il = function(a) {
            ...
            var b = ok(a, "apiKey") || null,
                ...
                d = ok(a, "mode") || null;
            d = d ? Hl[d] || null : null;
            if (!b || !c || !d) throw new P("argument-error", "apiKey, oobCodeand mode are required in a valid action code URL.");
            rl(this, {
                apiKey: b,
                operation: d,
                code: c,
    ...
    var Ll = function(a) {
        ...
        a = d.Ga;
        d = d.Va;
        "chrome-extension" == d ? c = Pc("This chrome extension ID (chrome-extension://%s) is not authorized to run this operation. Add it to the OAuth redirect domains list in the Firebase console -> Auth section -> Sign in method tab.", a) : "http" == d || "https" == d ? c = Pc("This domain (%s) is not authorized to run this operation. Add it to the OAuth redirect domains list in the Firebase console -> Auth section -> Sign in method tab.", a) : b =
            ...
            try {
                ...
                for (c = b = 0; b < d.length;) {
                    ...
                    if (128 > e) a[c++] = String.fromCharCode(e);
                        ...
                        a[c++] = String.fromCharCode(55296 + (l >>
                            10));
    ...
    var Xl = function(a) {
        ...
        Yl = function(a, b, c) {
            this.Yb = null;
            if (b.idToken || b.accessToken) b.idToken && O(this, "idToken", b.idToken), b.accessToken && O(this, "accessToken", b.accessToken), b.nonce && !b.pendingToken && O(this, "nonce", b.nonce), b.pendingToken && (this.Yb = b.pendingToken);
            else if (b.oauthToken && b.oauthTokenSecret) O(this, "accessToken", b.oauthToken), O(this, "secret",
                b.oauthTokenSecret);
            else throw new P("internal-error", "failed to construct a credential");
            O(this, "providerId", a);
    ...
    bm.prototype.credential = function(a, b) {
        ...
        if (!a.idToken && !a.accessToken) throw new P("argument-error", "credential failed: must provide the ID token and/or the access token.");
    ...
    var jm = function(a, b) {
            ...
            if (!c.oauthToken || !c.oauthTokenSecret) throw new P("argument-error", "credential failed: expected 2 arguments (the OAuth access token and secret).");
        ...
        lm = function(a, b, c) {
            ...
            O(this, "signInMethod", c === km.EMAIL_LINK_SIGN_IN_METHOD ? km.EMAIL_LINK_SIGN_IN_METHOD : km.EMAIL_PASSWORD_SIGN_IN_METHOD)
        };
    lm.prototype.Lc = function(a) {
        return this.signInMethod == km.EMAIL_LINK_SIGN_IN_METHOD ? Q(a, mm, {
            email: this.Ic,
            oobCode: this.qe
        }) : Q(a, nm, {
            email: this.Ic,
    ...
    lm.prototype.yd = function(a, b) {
        return this.signInMethod == km.EMAIL_LINK_SIGN_IN_METHOD ? Q(a, om, {
            idToken: b,
            email: this.Ic,
            oobCode: this.qe
        }) : Q(a, pm, {
    ...
    ym.prototype.verifyPhoneNumber = function(a, b) {
        ...
        return F(b.verify()).then(function(d) {
            if ("string" !== typeof d) throw new P("argument-error", "An implementation of firebase.auth.ApplicationVerifier.prototype.verify() must return a firebase.Promise that resolves with a string.");
            switch (b.type) {
                case "recaptcha":
                    var e = t(a) ? a.session : null,
                        f = t(a) ? a.phoneNumber : a;
                    return (e && "enroll" == e.type ? e.ee().then(function(g) {
                            return zm(c, {
                                idToken: g,
                                phoneEnrollmentInfo: {
                                    phoneNumber: f,
                        ...
                        "signin" == e.type ? e.ee().then(function(g) {
                            return Am(c, {
    ...
    var Dm = function(a) {
            if (a.temporaryProof && a.phoneNumber) return new tm({
                He: a.temporaryProof,
            ...
            try {
                switch (b) {
                    ...
                    case "twitter.com":
                        return jm(c, d);
                    default:
                        return c || d || f || g ? g ? 0 == b.indexOf("saml.") ? new Tl(b, g) : new Yl(b, {
                            pendingToken: g,
                            idToken: a.oauthIdToken,
                            accessToken: a.oauthAccessToken
                        }, b) : (new bm(b)).credential({
                            idToken: f,
                            accessToken: c,
                            rawNonce: e
                        }) : null
    ...
    var Mm = function(a, b, c) {
            ...
            if (!a && !Qk()) throw new P("internal-error", "The XMLHttpRequest compatibility library was not found.");
            this.Nf = void 0;
            Qk() ? this.Nf = new jj({
                Am: self
            }) : Sk() ? this.Nf = new Hm(a) : this.Nf = new gj;
            this.ma = null
        },
        Nm, Om = function(a, b) {
        ...
        Qm = function(a, b) {
            b && (a.Ej = Pm("https://securetoken.googleapis.com/v1/token", b), a.yi = Pm("https://www.googleapis.com/identitytoolkit/v3/relyingparty/",
                b), a.Ni = Pm("https://identitytoolkit.googleapis.com/v2/", b))
        },
        Pm = function(a, b) {
            a = M(a);
            b = M(b.url);
        ...
        Rm = function(a, b) {
            b ? (a.nd["X-Client-Version"] = b, a.Pf["X-Client-Version"] = b) : (delete a.nd["X-Client-Version"], delete a.Pf["X-Client-Version"])
        },
        Tm = function(a, b, c, d, e, f, g) {
            Dk() || Qk() ? a = u(a.km, a) : (Nm || (Nm = new E(function(h, l) {
                Sm(h, l)
            })), a = u(a.jm, a));
            a(b, c, d, e, f, g)
        };
    Mm.prototype.km = function(a, b, c, d, e, f) {
        if (Qk() && ("undefined" === typeof p.fetch || "undefined" === typeof p.Headers || "undefined" === typeof p.Request)) throw new P("operation-not-supported-in-this-environment", "fetch, Headers and Request native APIs or equivalent Polyfills must be available to support HTTP requests from a Worker environment.");
    ...
    var Xm = function(a, b) {
            return new E(function(c, d) {
                "refresh_token" == b.grant_type && b.refresh_token || "authorization_code" == b.grant_type && b.code ? Tm(a, a.Ej + "?key=" + encodeURIComponent(a.ha), function(e) {
                    e ? e.error ? d(Wm(e)) : e.access_token && e.refresh_token ? c(e) : d(new P("internal-error")) : d(new P("network-request-failed"))
                }, "POST", sk(b).toString(), a.Pf, a.im.get()) : d(new P("internal-error"))
            })
        },
        Ym = function(a, b, c, d, e, f, g) {
            ...
            var l = "GET" == d;
            if (l)
                for (var m in e) e.hasOwnProperty(m) &&
                    L(h, m, e[m]);
            return new E(function(q, x) {
                Tm(a, h.toString(), function(z) {
                    z ? z.error ? x(Wm(z, f || {})) : q(z) : x(new P("network-request-failed"))
                }, d, l ? void 0 : JSON.stringify(bl(e)), a.nd, a.Kk.get())
            })
        },
        Zm = function(a) {
            a = a.email;
        ...
        bn = function(a, b) {
            return Q(a, an, {
                identifier: b,
                continueUri: Yk() ? zk() : "http://localhost"
            }).then(function(c) {
    ...
    var zm = function(a, b) {
        ...
        vn = function(a) {
            if (!a.requestUri ||
                !a.sessionId && !a.postBody && !a.pendingToken) throw new P("internal-error");
        },
        wn = function(a, b) {
            b.oauthIdToken && b.providerId && 0 == b.providerId.indexOf("oidc.") && !b.pendingToken && (a.sessionId ? b.nonce = a.sessionId : a.postBody && (a = new hk(a.postBody), tk(a, "nonce") && (b.nonce = a.get("nonce"))));
            return b
        },
        yn = function(a) {
            var b = null;
            a.needConfirmation ? (a.code = "account-exists-with-different-credential", b = Gm(a)) : "FEDERATED_USER_ID_ALREADY_LINKED" == a.errorMessage ? (a.code = "credential-already-in-use", b = Gm(a)) : "EMAIL_EXISTS" ==
                a.errorMessage ? (a.code = "email-already-in-use", b = Gm(a)) : a.errorMessage && (b = xn(a.errorMessage));
            if (b) throw b;
            en(a)
        },
        Ul = function(a, b) {
    ...
    var Q = function(a, b, c) {
            ...
            return F(c).then(b.oa).then(function() {
                ...
                return d ? Ym(a, a.Ni, b.endpoint, e, c, b.ki, b.qg || !1) : Ym(a, a.yi, b.endpoint, e, c, b.ki, b.qg || !1)
            }).then(function(g) {
                f = g;
        ...
        sn = {
            ...
            Aa: function(a) {
                if (!a.phoneResponseInfo ||
                    !a.phoneResponseInfo.sessionInfo) throw new P("internal-error");
            },
            ta: !0,
            Le: !0
        },
    ...
    var Qn = function() {
            return Sn ? Sn : Sn = (new E(function(a, b) {
                var c = function() {
                    el();
    ...
    var Vn = function(a, b, c, d) {
        ...
        this.N = d;
        this.Yc = null;
        this.N ? (a = M(this.N.url), a = pk(a.Va, a.Ga, a.Ub, "/emulator/auth/iframe")) : a = pk("https", this.ya, null, "/__/auth/iframe");
        this.jc = a;
    ...
    Wn.prototype.toString = function() {
        ...
        if (this.Fd.isOAuthProvider) {
            ...
            c.Tg &&
                c.yg && !b[c.Tg] && (b[c.Tg] = c.yg);
            Xa(b) || L(a, "customParameters", al(b))
        }
        "function" === typeof this.Fd.Ei && (c = this.Fd.Ei(), c.length && L(a, "scopes", c.join(",")));
    ...
    k.Ee = function(a, b, c) {
        ...
        return this.Oc().then(function() {
            ...
            if (!g) return Jj(c).then(function() {
                b(d)
            })
        })
    };
    ...
    k.ve = function(a, b, c, d, e, f, g, h) {
        ...
        if (g && !$k()) return this.Oc().l(function(m) {
            Fk(a);
            e(m)
        }), d(), F();
    ...
    var ao = function(a) {
        a.o || (a.Bi = a.Fc ? Vk("JsCore", a.Fc, Xn(a.ka)) : null, a.o = new Mm(a.ha, vk(a.Ia), a.Bi), a.N && Qm(a.o, a.N));
        return a.o
    };
    ...
    var go = new kb(ib, "https://www.google.com/recaptcha/api.js?trustedtypes=true&onload=%{onload}&render=explicit&hl=%{hl}"),
        fo = new fl(3E4, 6E4),
        ho = null;
    var io = function() {
        this.hb = {};
    ...
    jo.prototype.execute = function() {
        no(this);
        var a = this;
        this.Nd || (this.Nd = setTimeout(function() {
            a.Lf = Tk();
            var b = a.wa.callback,
    ...
    var qo = function(a, b, c, d, e, f, g) {
        ...
        this.Ka = [];
        if (this.uc.sitekey) throw new P("argument-error", "sitekey should not be provided for reCAPTCHA as one is automatically provisioned for the current project.");
        this.uf = "invisible" === this.uc.size;
        if (!p.document) throw new P("operation-not-supported-in-this-environment", "RecaptchaVerifier is only supported in a browser HTTP/HTTPS environment with DOM support.");
        if (!Qc(b) || !this.uf && Qc(b).hasChildNodes()) throw new P("argument-error", "reCAPTCHA container is either not found or already contains inner elements!");
    ...
    qo.prototype.Yd = function(a) {
        for (var b = 0; b < this.Wf.length; b++) try {
            this.Wf[b](a)
        } catch (c) {}
    };
    var ro = function(a, b) {
    ...
    k.ke = function() {
        var a = this;
        return this.Ud ? this.Ud : this.Ud = this.v(F().then(function() {
            if (Yk() && !Qk()) return Lk();
    ...
    k.render = function() {
        so(this);
        var a = this;
        return this.v(this.ke().then(function() {
            if (null === a.Rd) {
                var b = a.fi;
                if (!a.uf) {
                    var c = Qc(b);
    ...
    qo.prototype.clear = function() {
        ...
        this.ld = !0;
        this.zj.di();
        for (var a = 0; a < this.Ka.length; a++) this.Ka[a].cancel("RecaptchaVerifier instance has been destroyed.");
    ...
    vo.prototype.send = function(a, b, c) {
        ...
        return (new E(function(x, z) {
            q ? (e = "" + Math.floor(Math.random() * Math.pow(10, 20)).toString(), q.port1.start(), g = setTimeout(function() {
                z(Error("unsupported_event"))
            }, m), f = function(R) {
                R.data.eventId === e && ("ack" === R.data.status ? (clearTimeout(g), h = setTimeout(function() {
                        z(Error("timeout"))
                    },
                    3E3)) : "done" === R.data.status ? (clearTimeout(h), "undefined" !== typeof R.data.response ? x(R.data.response) : z(Error("unknown_error"))) : (clearTimeout(g), clearTimeout(h), z(Error("invalid_response"))))
            }, l = {
                messageChannel: q,
                onMessage: f
            }, d.yf.push(l), q.port1.addEventListener("message", f), d.Nl.postMessage({
                eventType: a,
                eventId: e,
                data: b
            }, [q.port2])) : z(Error("connection_unavailable"))
        })).then(function(x) {
            wo(d, l);
            return x
        }).l(function(x) {
    ...
    xo.prototype.unsubscribe = function(a, b) {
        "undefined" !== typeof this.Eb[a] && b ? (Ra(this.Eb[a], function(c) {
            return c == b
        }), 0 == this.Eb[a].length && delete this.Eb[a]) : b || delete this.Eb[a];
    ...
    var Ao = function(a) {
        ...
        if (!this.ub) throw new P("internal-error", "The React Native compatibility library was not found.");
    ...
    var Eo = function() {
            if (!Co()) {
                if ("Node" == Rk()) throw new P("internal-error", "The LocalStorage compatibility library was not found.");
        ...
        Co = function() {
            ...
            if (!a) return !1;
            try {
                return a.setItem("__sak",
                    "1"), a.removeItem("__sak"), !0
            } catch (b) {
                return !1
            }
        };
    ...
    var Io = function() {
            if (!Go()) {
                if ("Node" == Rk()) throw new P("internal-error", "The SessionStorage compatibility library was not found.");
                throw new P("web-storage-unsupported");
            }
    ...
    var Lo = function() {
            ...
            this.fg = null;
            var a = this;
            Qk() && self ? (this.vc = zo(Qk() ? self : null), this.vc.subscribe("keyChanged", function(b, c) {
                    return Ko(a).then(function(d) {
                        0 < d.length && y(a.Vb, function(e) {
                            e(d)
                        });
                        return {
                ...
                if (a.fg = b) a.Qf = new vo(new uo(b)), a.Qf.send("ping", null, !0).then(function(c) {
        ...
        Oo = function(a) {
            return new E(function(b, c) {
                ...
                d.onsuccess = function(e) {
                    e = e.target.result;
                    e.objectStoreNames.contains(a.Af) ? b(e) : No(a).then(function() {
                        return Oo(a)
                    }).then(function(f) {
                        b(f)
                    }).l(function(f) {
        ...
        Qo = function(a, b) {
            var c = 0,
                d = function(e, f) {
                    Po(a).then(b).then(e).l(function(g) {
                        if (3 < ++c) f(g);
                        else return Po(a).then(function(h) {
                            h.close();
                            a.Og = void 0;
                            return d(e, f)
                        }).l(function(h) {
    ...
    var Uo = function(a, b) {
        return a.Qf && a.fg && ll() === a.fg ? a.Qf.send("keyChanged", {
            key: b
    ...
    var Ko = function(a) {
        return Po(a).then(function(b) {
            var c = Ro(a, So(a, b, !1));
            return c.getAll ? To(c.getAll()) : new E(function(d, e) {
                var f = [],
                    g = c.openCursor();
    ...
    Lo.prototype.Lh = function() {
        ...
        var b = function() {
            a.Hf = setTimeout(function() {
                a.ih = Ko(a).then(function(c) {
                    0 < c.length && y(a.Vb, function(d) {
                        d(c)
                    })
                }).then(function() {
                    b()
    ...
    cp.prototype.Qg = function(a) {
        ...
        if (c && "object" === typeof c) {
            ...
            if ("string" === typeof b && b.length) {
                this.ig = b;
                if ("undefined" !== typeof d && "boolean" !== typeof d) throw new P("argument-error", "installApp property must be a boolean when specified.");
                this.Si = !!d;
                if ("undefined" !== typeof c && ("string" !== typeof c || "string" === typeof c && !c.length)) throw new P("argument-error", "minimumVersion property must be a non empty string when specified.");
                this.Vh = c || null
            } else {
                if ("undefined" !== typeof b) throw new P("argument-error", "packageName property must be a non empty string when specified.");
                if ("undefined" !== typeof d || "undefined" !== typeof c) throw new P("missing-android-pkg-name");
            }
        } else if ("undefined" !== typeof c) throw new P("argument-error", "android property must be a non null object when specified.");
        this.Mi = null;
        if ((b = a.iOS) && "object" === typeof b)
            if (b = b.bundleId, "string" === typeof b && b.length) this.Mi = b;
            else {
                if ("undefined" !== typeof b) throw new P("argument-error", "bundleId property must be a non empty string when specified.");
            }
        else if ("undefined" !== typeof b) throw new P("argument-error", "iOS property must be a non null object when specified.");
        b = a.handleCodeInApp;
        if ("undefined" !== typeof b && "boolean" !== typeof b) throw new P("argument-error", "handleCodeInApp property must be a boolean when specified.");
        this.ci = !!b;
        a = a.dynamicLinkDomain;
        if ("undefined" !== typeof a && ("string" !== typeof a || "string" === typeof a && !a.length)) throw new P("argument-error", "dynamicLinkDomain property must be a non empty string when specified.");
        this.Dk = a || null
    };
    var dp = function(a) {
        var b = {};
        ...
        if (b.androidPackageName = a.ig) b.androidMinimumVersion = a.Vh, b.androidInstallApp = a.Si;
        b.iOSBundleId = a.Mi;
    ...
    var pp = function(a) {
        ...
        op = function(a) {
            ...
            c = !1;
            "undefined" !== typeof a.isNewUser ? c = !!a.isNewUser : "identitytoolkit#SignupNewUserResponse" ===
                a.kind && (c = !0);
            O(this, "providerId", b);
            O(this, "isNewUser", c)
        },
    ...
    var qp = {
        ...
        sp = function() {
            ...
            a = ap;
            try {
                this.vj = !yk() && kl() || !p.indexedDB ? new a.Ag.ua : new Vo(Qk() ? new Bo : new a.Ag.ua)
            } catch (d) {
    ...
    k.removeListener = function(a, b, c) {
        a = this.ob(a, b);
        this.ab[a] && (Ra(this.ab[a], function(d) {
            return d == c
        ...
        if (a && a.Nk) {
            ...
            if (null == b)
                for (var c in this.ab) {
                    ...
                    if (this.em)
                        if (c = p.localStorage.getItem(b), d = a.Ya.newValue, d !== c) null !== d ? p.localStorage.setItem(b, d) : p.localStorage.removeItem(b);
                        else if (this.Ra[b] === d && "undefined" === typeof a.Ya.hh) return;
                    var f = this;
                    c = function() {
                        if ("undefined" !== typeof a.Ya.hh || f.Ra[b] !== p.localStorage.getItem(b)) f.Ra[b] = p.localStorage.getItem(b), f.rg(b)
                    };
                    sc && Hc && 10 == Hc && p.localStorage.getItem(b) !== a.Ya.newValue && a.Ya.newValue !== a.Ya.oldValue ? setTimeout(c, 10) : c()
                }
        } else y(a, u(this.rg, this))
    };
    sp.prototype.rg = function(a) {
        this.ab[a] && y(this.ab[a], function(b) {
            b()
        })
    };
    var zp = function(a) {
    ...
    Hp.prototype.subscribe = function(a) {
        ...
        }, a = N("universalLinks.subscribe", p), "function" === typeof a && a(null, this.Wg))
    };
    ...
    Jp.prototype.Oc = function() {
        return this.ke ? this.ke : this.ke = Nk().then(function() {
            if ("function" !== typeof N("universalLinks.subscribe", p)) throw Kp("cordova-universal-links-plugin-fix is not installed");
            if ("undefined" === typeof N("BuildInfo.packageName", p)) throw Kp("cordova-plugin-buildinfo is not installed");
            if ("function" !== typeof N("cordova.plugins.browsertab.openUrl", p)) throw Kp("cordova-plugin-browsertab is not installed");
            if ("function" !== typeof N("cordova.InAppBrowser.open", p)) throw Kp("cordova-plugin-inappbrowser is not installed");
        }, function() {
    ...
    k.we = function(a, b, c, d) {
        ...
        var e = this,
            ...
            l = null,
            m = null;
        return this.Gf = F().then(function() {
            Em(b);
            return Np(e)
        }).then(function() {
            return Op(e, a, b, c, d)
            ...
            return (new E(function(q, x) {
                ...
                xk().toLowerCase().match(/android/) || f.addEventListener("visibilitychange", m, !1)
            })).l(function(q) {
    ...
    var Op = function(a, b, c, d, e) {
        ...
        var l = N("BuildInfo.displayName", p),
            m = {};
        if (xk().toLowerCase().match(/iphone|ipad|ipod/)) m.ibi = h;
        else if (xk().toLowerCase().match(/android/)) m.apn = h;
        ...
        return a.Oc().then(function() {
            ...
            x(function(R) {
                if (R) {
                    ...
                    R = z;
                    var Ca = xk();
                    Ca = !(!Ca.match(/(iPad|iPhone|iPod).*OS 7_\d/i) &&
    ...
    Jp.prototype.Yd = function(a) {
        for (var b = 0; b < this.Wb.length; b++) try {
            this.Wb[b](a)
        } catch (c) {}
    };
    var Np = function(a) {
            a.Pg || (a.Pg = a.Oc().then(function() {
                return new E(function(b) {
                    var c = function(d) {
                        b(d);
                        a.Id(c);
        ...
        Pp = function(a) {
            var b = null;
            return Bp(a.Ci).then(function(c) {
                b = c;
                return Cp(a.Ci)
            }).then(function() {
                return b
            ...
            var b = new Bl("unknown", null, null, null, new P("no-auth-event")),
                ...
                e = function(g) {
                    ...
                    Pp(a).then(function(h) {
                        ...
                        if (h && g && g.url) {
                            var m = null;
                            l = Kl(g.url); - 1 != l.indexOf("/__/auth/callback") && (m = M(l), m = cl(ok(m, "firebaseError") || null), m = (m = "object" === typeof m ? Al(m) : null) ? new Bl(h.getType(), h.Ja, null, null, m, null, h.ma) : new Bl(h.getType(), h.Ja, l, h.fe(), null, null, h.ma));
                            l = m || b
                        }
                        a.Yd(l)
                    })
    ...
    Jp.prototype.Dc = function(a) {
        ...
        Np(this).l(function(b) {
            "auth/invalid-cordova-configuration" === b.code && (b = new Bl("unknown", null, null, null, new P("no-auth-event")), a(b))
        })
    };
    ...
    var cq = function(a) {
        a.rb.Oj() && a.initialize().l(function(b) {
            var c = new Bl("unknown", null, null, null, new P("operation-not-supported-in-this-environment"));
            aq(b) && a.Jg(c)
        });
        a.rb.Ji() || bq(a.wc)
    };
    ...
    k.subscribe = function(a) {
        ...
        if (!this.xd) {
            var b = this;
            Vp(this.te).then(function(c) {
                c ? Up(b.te).then(function() {
                    b.initialize().l(function(d) {
                        var e = new Bl("unknown", null, null, null, new P("operation-not-supported-in-this-environment"));
                        aq(d) && b.Jg(e)
                    })
                }) : cq(b)
            }).l(function() {
    ...
    k.Jg = function(a) {
        ...
        for (var b = !1, c = 0; c < this.Ge.length; c++) {
            ...
            if (d.bi(a.getType(), a.Ja)) {
                if (b = this.Cc[a.getType()]) b.xj(a, d), a && (a.fe() || a.Ja) && (this.If[a.getUid()] = !0, this.Ug = Date.now());
                b = !0;
                break
            }
        }
    ...
    k.ve = function(a, b, c, d, e, f) {
        var g = this;
        return this.rb.ve(a, b, c, function() {
    ...
    $p.prototype.we = function(a, b, c, d) {
        ...
        return Tp(this.te).then(function() {
            return e.rb.we(a, b, c, d).l(function(g) {
                ...
                return e.rb.Tj() ? new E(function() {}) : Up(e.te).then(function() {
    ...
    $p.prototype.Ee = function(a, b, c, d) {
        return this.rb.Ee(c, function(e) {
            a.Uc(b, null, e, d)
        }, dq.get())
    };
    ...
    Wp.prototype.xj = function(a, b) {
        if (a) {
            ...
            this.Uj = !(!e && !f);
            "unknown" != c || e || f ? a.Ab ? this.oh(a, b) : b.de(c, d) ? this.qh(a, b) : G(new P("invalid-auth-event")) : (hq(this, !1, null, null), F())
    ...
    var iq = function(a, b) {
            ...
            if (a.ye.length)
                for (var c = 0; c < a.ye.length; c++) a.ye[c](b)
        },
        jq = function(a, b) {
            a.Hd = function() {
                return F(b)
            ...
            if (a.ze.length)
                for (var c = 0; c < a.ze.length; c++) a.ze[c](b)
        },
        hq = function(a, b, c, d) {
            b ? d ? iq(a, d) : jq(a, c) : jq(a, {
                user: null
            });
            a.ze = [];
            a.ye = []
    ...
    Xp.prototype.qh = function(a, b) {
        var c = a.Ja,
            ...
            f = a.Od,
            g = a.fe();
        e(f, g, a.ma, a.kh).then(function(h) {
            b.Uc(d, h, null, c)
        }).l(function(h) {
            b.Uc(d, null, h, c)
        })
    ...
    var sq = function(a) {
        rq.call(this, a);
        if (this.Xg.providerId != ym.PROVIDER_ID) throw new P("argument-error", "firebase.auth.PhoneMultiFactorAssertion requires a valid firebase.auth.PhoneAuthCredential");
    };
    v(sq, rq);
    var tq = function(a, b) {
        Ai.call(this, a);
    ...
    var vq = function(a, b) {
            ...
            var c = [];
            b && b.multiFactor && b.multiFactor.enrolledFactors && y(b.multiFactor.enrolledFactors, function(d) {
                var e = null,
                    f = {};
                if (d) {
    ...
    k.unenroll = function(a) {
        var b = this,
            ...
            d = this.kc.o;
        return this.kc.getIdToken().then(function(e) {
            return Q(d, Nn, {
                idToken: e,
                mfaEnrollmentId: c
            })
    ...
    var Bq = function(a, b) {
        return Xm(a.o, b).then(function(c) {
    ...
    yq.prototype.getToken = function(a) {
        a = !!a;
        return this.Wa && !this.Ta ? G(new P("user-token-expired")) : a || !this.Wa || Date.now() > this.md - 3E4 ? this.Ta ? Bq(this, {
    ...
    var Cq = function(a, b) {
        ...
        this.Xi = b || null;
        rl(this, {
            lastSignInTime: jl(b || null),
            creationTime: jl(a || null)
        })
    };
    ...
    var Hq = function(a, b) {
            a.N = b;
            Qm(a.o, b);
            a.W && (b = a.W, a.W = fq(a.ya, a.ha, a.ka, a.N), a.ue && (b.unsubscribe(a), a.W.subscribe(a)))
        },
        Jq = function(a, b) {
    ...
    S.prototype.copy = function(a) {
        ...
        b != a && (rl(this, {
            ...
            tenantId: a.tenantId,
            providerData: []
        }), a.metadata ? O(this, "metadata", a.metadata.clone()) : O(this, "metadata", new Cq), y(a.providerData, function(c) {
            Wq(b, c)
        }), this.Ob.copy(a.Ob), O(this, "refreshToken", this.Ob.Ta), this.zf.copy(a.zf))
    };
    S.prototype.reload = function() {
        var a = this;
        return this.v(Tq(this).then(function() {
    ...
    var xq = function(a, b) {
        b.idToken && a.Wi != b.idToken && (Aq(a.Ob, b), a.tc(), Eq(a, b.idToken), Xq(a, "refreshToken", a.Ob.Ta))
    };
    ...
    S.prototype.Ll = function(a) {
        ...
        Xq(this, "isAnonymous", !(this.email && a.passwordHash) && !(this.providerData && this.providerData.length));
        this.dispatchEvent(new tq("userReloaded", {
            vm: a
        }))
    };
    var Zq = function(a) {
        return (a = a.providerUserInfo) && a.length ? Ma(a, function(b) {
    ...
    S.prototype.reauthenticateAndRetrieveDataWithCredential = function(a) {
        ol("firebase.User.prototype.reauthenticateAndRetrieveDataWithCredential is deprecated. Please use firebase.User.prototype.reauthenticateWithCredential instead.");
        return this.reauthenticateWithCredential(a)
    };
    S.prototype.reauthenticateWithCredential = function(a) {
        var b = this,
            c = null;
        return this.v(a.oe(this.o, this.uid).then(function(d) {
            xq(b, d);
    ...
    var ar = function(a, b) {
        return Yq(a).then(function() {
            if (Oa(Uq(a), b)) return Qq(a).then(function() {
                throw new P("provider-already-linked");
            })
        })
    };
    S.prototype.linkAndRetrieveDataWithCredential = function(a) {
        ol("firebase.User.prototype.linkAndRetrieveDataWithCredential is deprecated. Please use firebase.User.prototype.linkWithCredential instead.");
        return this.linkWithCredential(a)
    };
    S.prototype.linkWithCredential = function(a) {
        var b = this,
            c = null;
        return this.v(ar(this, a.providerId).then(function() {
            return b.getIdToken()
        }).then(function(d) {
            return a.yd(b.o, d)
        }).then(function(d) {
    ...
    S.prototype.linkWithPhoneNumber = function(a, b) {
        var c = this;
        return this.v(ar(this, "phone").then(function() {
    ...
    k.updateProfile = function(a) {
        ...
        return this.v(this.getIdToken().then(function(c) {
            ...
            y(b.providerData, function(d) {
                "password" === d.providerId && (O(d, "displayName", b.displayName), O(d, "photoURL", b.photoURL))
            });
            return Qq(b)
        }).then(Sq))
    };
    k.unlink = function(a) {
        var b = this;
        return this.v(Yq(this).then(function(c) {
            return Oa(Uq(b), a) ? un(b.o, c, [a]).then(function(d) {
                var e = {};
    ...
    k.bi = function(a, b) {
        return "linkViaPopup" == a && (this.Lb || null) == b && this.Kb || "reauthViaPopup" == a && (this.Lb || null) == b && this.Kb || "linkViaRedirect" == a && (this.xc || null) == b || "reauthViaRedirect" == a && (this.xc || null) == b ? !0 : !1
    };
    k.Uc = function(a, b, c, d) {
        "linkViaPopup" != a && "reauthViaPopup" != a || d != (this.Lb || null) || (c && this.Sc ? this.Sc(c) : b && !c && this.Kb && this.Kb(b), this.La && (this.La.cancel(), this.La = null), delete this.Kb, delete this.Sc)
    };
    k.de = function(a, b) {
        return "linkViaPopup" == a && b == (this.Lb || null) ? u(this.wi, this) : "reauthViaPopup" == a && b == (this.Lb || null) ? u(this.xi, this) : "linkViaRedirect" == a && (this.xc || null) == b ? u(this.wi, this) : "reauthViaRedirect" == a && (this.xc || null) == b ? u(this.xi, this) : null
    };
    k.df = function() {
        return Wk(this.uid + ":::")
    };
    k.linkWithPopup = function(a) {
        var b = this;
        return cr(this, "linkViaPopup", a, function() {
    ...
    k.reauthenticateWithPopup = function(a) {
        return cr(this, "reauthViaPopup", a, function() {
            return F()
        }, !0)
    };
    var cr = function(a, b, c, d, e) {
        ...
        var f = yl(c.providerId),
            g = a.df(),
            h = null;
        (!$k() || Pk()) && a.ya && c.isOAuthProvider && (h = bo(a.ya, a.ha, a.ka, b, c, null, g, firebase.SDK_VERSION || null, null, null, a.tenantId, a.N));
        ...
        d = d().then(function() {
            ...
            return new E(function(m, q) {
                a.Uc(b,
                    null, new P("cancelled-popup-request"), a.Lb || null);
                a.Kb = m;
                a.Sc = q;
                a.Lb = g;
                a.La = a.W.Ee(a, b, l, g)
    ...
    S.prototype.linkWithRedirect = function(a) {
        var b = this;
        return er(this, "linkViaRedirect", a, function() {
            return ar(b, a.providerId)
        }, !1)
    };
    S.prototype.reauthenticateWithRedirect = function(a) {
        return er(this, "reauthViaRedirect", a, function() {
            return F()
        }, !0)
    };
    ...
    k.Kg = function(a) {
        var b = null,
            c = this;
        a = Sl(F(a), c.uid).then(function(d) {
    ...
    var hr = function(a, b, c) {
        return a.Pb && !c ? (b.cancel(), G(a.Pb)) : b.l(function(d) {
            !d || "auth/user-disabled" != d.code && "auth/user-token-expired" != d.code || (a.Pb || a.dispatchEvent(new tq("userInvalidated")), a.Pb = d);
            throw d;
        })
    };
    ...
    var ir = function(a) {
            ...
            var e = new S(b, c, a);
            a.providerData && y(a.providerData, function(f) {
                f && Wq(e, sl(f))
            });
    ...
    or.prototype.nm = function() {
        ...
        pr(this, function() {
            return F().then(function() {
                ...
                if (c) return qr(a, "local").then(function() {
                    a.Xa = b
                })
            })
        })
    ...
    var T = function(a) {
        ...
        O(this, "app", a);
        if (this.U().options && this.U().options.apiKey) a = firebase.SDK_VERSION ? Vk("JsCore", firebase.SDK_VERSION) : null, this.o = new Mm(this.U().options && this.U().options.apiKey, vk(wk), a);
        else throw new P("invalid-api-key");
        this.Ka = [];
        this.Ec = [];
        this.Pd = [];
    ...
    T.prototype.Kd = function(a) {
        this.Hb === a || this.yb || (this.Hb = a, Om(this.o, this.Hb), this.dispatchEvent(new Br(this.Hb)))
    };
    ...
    T.prototype.useEmulator = function(a, b) {
        if (!this.N) {
            if (this.W) throw new P("argument-error", "useEmulator() must be called immediately following firebase.auth() initialization.");
    ...
    k.Uc = function(a, b, c, d) {
        "signInViaPopup" == a && this.Lb == d && (c && this.Sc ? this.Sc(c) : b && !c && this.Kb && this.Kb(b), this.La && (this.La.cancel(), this.La = null), delete this.Kb, delete this.Sc)
    };
    k.de = function(a, b) {
        return "signInViaRedirect" == a || "signInViaPopup" == a && this.Lb == b && this.Kb ? u(this.Jk, this) : null
    };
    ...
    k.signInWithPopup = function(a) {
        ...
        var b = this,
            ...
            d = this.df(),
            e = null;
        (!$k() || Pk()) && this.U().options.authDomain && a.isOAuthProvider && (e = bo(this.U().options.authDomain, this.U().options.apiKey, this.U().name, "signInViaPopup", a, null, d, firebase.SDK_VERSION || null, null, null, this.ma, this.N));
        var f = Gk(e, c && c.Dd, c && c.Cd);
        c = Fr(this).then(function(g) {
            return g.ve(f, "signInViaPopup", a, d, !!e, b.ma)
        }).then(function() {
            return new E(function(g,
                h) {
    ...
    T.prototype.getRedirectResult = function() {
        var a = this;
        return Hr(this).then(function(b) {
            a.W && a.W.jd();
            return b
        }).l(function(b) {
            a.W && a.W.jd();
    ...
    T.prototype.updateCurrentUser = function(a) {
        ...
        return this.v(this.Mb.then(function() {
    ...
    var Ir = function(a, b) {
        ...
        wr = function(a, b) {
            U(a) && (Pq(U(a), a.Yj), Xi(U(a), "tokenChanged", a.Qd), Xi(U(a), "userDeleted", a.Wj), Xi(U(a), "userInvalidated", a.Xj), Oq(U(a)));
            b && (b.Sf.push(a.Yj), Pi(b, "tokenChanged",
                a.Qd), Pi(b, "userDeleted", a.Wj), Pi(b, "userInvalidated", a.Xj), 0 < a.Jc && Nq(b));
            O(a, "currentUser", b);
    ...
    var Jr = function(a) {
        ...
        xr = function(a) {
            var b = a.U().options.authDomain,
                c = Jr(a).then(function() {
                    return vr(a.Qb, b, a.N)
                }).then(function(d) {
                    return d ? (d.yc = a.Tc, a.zc && (a.zc.xc || null) == (d.xc || null) ? d : d.reload().then(function() {
    ...
    k.onIdTokenChanged = function(a, b, c) {
        var d = this;
        this.vf && firebase.Promise.resolve().then(function() {
    ...
    k.signInAndRetrieveDataWithCredential = function(a) {
        ol("firebase.auth.Auth.prototype.signInAndRetrieveDataWithCredential is deprecated. Please use firebase.auth.Auth.prototype.signInWithCredential instead.");
    ...
    k.tc = function() {
        if (this.vf) {
            for (var a = 0; a < this.Ec.length; a++)
                if (this.Ec[a]) this.Ec[a](Lr(this));
    ...
    k.sendSignInLinkToEmail = function(a, b) {
        ...
        return this.v(F().then(function() {
            var d = new cp(b);
            if (!d.ci) throw new P("argument-error", "handleCodeInApp must be true when sending sign in link to email");
            return dp(d)
        }).then(function(d) {
            ...
            a: {
                ...
                for (var f = !1, g = 0; g < b.length; g++)
                    if (b[g].optional) f = !0;
                        ...
                        if (f) throw new P("internal-error", "Argument validator encountered a required argument after an optional argument.");
                        e++
                    }
                f = b.length;
                if (c.length < e || f < c.length) d = "Expected " + (e == f ? 1 == e ? "1 argument" : e + " arguments" : e + "-" + f + " arguments") + " but got " + c.length + ".";
                    ...
                    for (e = 0; e < c.length; e++)
                        if (f = b[e].optional && void 0 === c[e], !b[e].Ca(c[e]) && !f) {
                            b = b[e];
                            if (0 > e || e >= Mr.length) throw new P("internal-error",
    ...
    var Y = function(a, b) {
        ...
        $r = function(a, b, c) {
            ...
            for (var f in b.prototype) a.prototype[f] =
                b.prototype[f];
            return a
        },
        bs = function(a) {
    ...
    Y(T.prototype, {
        ...
        sendPasswordResetEmail: {
            ...
            j: [V("email"), X(W("opt_actionCodeSettings", !0), Qr(null, !0), "opt_actionCodeSettings", !0)]
        },
    ...
    Z(Rl, "fromJSON", function(a) {
        a = "string" === typeof a ? JSON.parse(a) : a;
        for (var b, c = [Zl, qm, xm, Xl], d = 0; d < c.length; d++)
            if (b = c[d](a)) return b;
        return null
    }, [X(V(), W(), "json")]);
    Z(km, "credential", function(a, b) {
        return new lm(a, b)
    }, [V("email"), V("password")]);
    Y(lm.prototype, {
        T: {
        ...
        verifyPhoneNumber: {
            ...
            j: [X(V(), function(a, b) {
                    return {
                        ...
                        optional: !!b,
                        Ca: function(c) {
                            return c ? c.session && c.phoneNumber ? Xr(c.session, "enroll") && "string" === typeof c.phoneNumber : c.session && c.multiFactorHint ? Xr(c.session, "signin") && Yr(c.multiFactorHint) : c.session && c.multiFactorUid ? Xr(c.session, "signin") && "string" === typeof c.multiFactorUid : c.phoneNumber ? "string" === typeof c.phoneNumber : !1 : !1
                        }
                    }
                }(), "phoneInfoOptions"),
                Zr()
    ...
    (function() {
        if ("undefined" !== typeof firebase && firebase.INTERNAL && firebase.INTERNAL.registerService) {
            ...
            Z(a, "RecaptchaVerifier", to, [X(V(), Rr(), "recaptchaContainer"), W("recaptchaParameters", !0), Tr()]);
            ...
            firebase.INTERNAL.registerService("auth", function(b, c) {
                ...
                c({
                    INTERNAL: {
                        ...
                        removeAuthTokenListener: u(b.Ql,
                            b)
                    }
                });
                return b
    ...
    ds.prototype.start = function() {
        var a = this;
        return this.Ib(this.Jb).then(function() {
            a.Mh = !0
        }).l(function(b) {
            throw b;
        })
    ...
    ds.prototype.sendMessage = function(a) {
        var b = this;
        if (this.Mh) return new E(function(c) {
    ...
    var gs = function(a, b, c) {
        ...
        this.vc.subscribe("sendAuthEvent", function(f, g) {
            ...
            if (f === p.window.location.origin && h === e.ha + ":" + e.ka && l) return e.Pi ? fs(e.rc, l).then(function() {
                return !0
            }).l(function() {
                return !1
            }) : e.Cl.O.set(Ap, l.T(), h).then(function() {
                return !0
            }).l(function() {
                return !1
            });
    ...
    gs.prototype.nj = function(a) {
        var b = this,
            c = null;
        return Bp(this.Ld).then(function(d) {
    ...
    var hs = function(a) {
        var b = null;
        return Ep(a.Ld).then(function(c) {
    ...
    var is = null,
        js = function() {
            ...
            is.start().l(function(d) {
                if (d && "auth/unauthorized-domain" == d.code) d = M(is.rd()), d = "chrome-extension" == d.Va ? Pc("Info: The current chrome extension ID is not authorized for OAuth operations. This will prevent signInWithPopup and linkWithPopup from working. Add your chrome extension (chrome-extension://%s) to the OAuth redirect domains list in the Firebase console -> Auth section -> Sign in method tab.",
                    d.Ga) : Pc("Info: The current domain is not authorized for OAuth operations. This will prevent signInWithPopup, signInWithRedirect, linkWithPopup and linkWithRedirect from working. Add your domain (%s) to the OAuth redirect domains list in the Firebase console -> Authentication -> Settings -> Authorized domains tab.", d.Ga), il(d);
                else if (d && d.message) il(d.message);
                else throw d;
            })
        };
    r("fireauth.iframe.AuthRelay.initialize", function() {
        "complete" == p.document.readyState ? js() : Oi(window, "load", function() {
            js()
        })
    });
}).call(this);