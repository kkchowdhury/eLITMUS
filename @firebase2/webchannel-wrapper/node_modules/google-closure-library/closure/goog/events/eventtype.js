...
goog.events.EventType = {
    ...
    ANIMATIONSTART: goog.events.EventTypeHelpers.getVendorPrefixedName_('AnimationStart'),
    ANIMATIONEND: goog.events.EventTypeHelpers.getVendorPrefixedName_('AnimationEnd'),
    ANIMATIONITERATION: goog.events.EventTypeHelpers.getVendorPrefixedName_('AnimationIteration'),

    // CSS transition events. Based on the browser support described at:
    // https://developer.mozilla.org/en/css/css_transitions#Browser_compatibility
    TRANSITIONEND: goog.events.EventTypeHelpers.getVendorPrefixedName_('TransitionEnd'),
