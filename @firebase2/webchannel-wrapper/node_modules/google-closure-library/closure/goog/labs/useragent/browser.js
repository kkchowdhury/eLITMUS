...
const {
    AsyncValue,
    Version
} = goog.require('goog.labs.userAgent.highEntropy.highEntropyValue');
const {
    compareVersions
...
const {
    fullVersionList,
    hasFullVersionList
} = goog.require('goog.labs.userAgent.highEntropy.highEntropyData');
...
function versionOf(browser) {
    ...
    if (useUserAgentDataBrand() && browser !== Brand.SILK) {
        ...
        const matchingBrand = data.brands.find(({
            brand
        }) => brand === browser);
